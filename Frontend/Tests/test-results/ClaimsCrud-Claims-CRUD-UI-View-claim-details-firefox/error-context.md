...
- Name: Claims CRUD UI >> View claim details
- Location: C:\temp\BCS\Frontend\Tests\ClaimsCrud.spec.ts:39:7
...
Call log:
  - navigating to "http://localhost:5000/claims", waiting until "load"

    at C:\temp\BCS\Frontend\Tests\ClaimsCrud.spec.ts:40:16
```
...
- paragraph:
  - text: http://localhost:5000/claims sent back an error.
