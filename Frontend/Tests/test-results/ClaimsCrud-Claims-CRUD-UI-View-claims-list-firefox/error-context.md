...
Call log:
  - navigating to "http://localhost:5000/claims-list", waiting until "load"

    at C:\temp\BCS\Frontend\Tests\ClaimsCrud.spec.ts:7:16
```
...
- paragraph:
  - text: http://localhost:5000/claims-list sent back an error.
