...
- Name: submit low risk claim and see risk score 0.1
- Location: C:\temp\BCS\Frontend\Tests\PlaywrightDemo.spec.ts:3:5
...
Call log:
  - waiting for locator('input[type="text"]').first() to be visible
    ...
    at C:\temp\BCS\Frontend\Tests\PlaywrightDemo.spec.ts:6:27
```
