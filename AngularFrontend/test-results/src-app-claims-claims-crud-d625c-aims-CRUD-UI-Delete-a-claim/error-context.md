...
- Name: Angular Claims CRUD UI >> Delete a claim
- Location: C:\temp\BCS\AngularFrontend\src\app\claims\claims-crud.spec.ts:43:7
...
Call log:
  - navigating to "http://localhost:4200/claims", waiting until "load"
    ...
    at C:\temp\BCS\AngularFrontend\src\app\claims\claims-crud.spec.ts:44:16
```
