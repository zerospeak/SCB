...
- Name: Angular Claims CRUD UI >> View claim details
- Location: C:\temp\BCS\AngularFrontend\src\app\claims\claims-crud.spec.ts:36:7
...
Call log:
  - navigating to "http://localhost:4200/claims", waiting until "load"
    ...
    at C:\temp\BCS\AngularFrontend\src\app\claims\claims-crud.spec.ts:37:16
```
